...
var classArea = ee.List.sequence(0, 4).map(function(classValue) {
  ...
  // Return the result as a feature with class and area
...
var areaCollection = ee.FeatureCollection(classArea);

// Print the areas to the console
print('Class-wise Area (m²):', areaCollection);

// Export the results to Google Drive as a CSV file
Export.table.toDrive({
  collection: areaCollection,
  description: 'LULC_Area',
  fileFormat: 'CSV'
});
