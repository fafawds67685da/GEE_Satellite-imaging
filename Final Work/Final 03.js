...
var sample = Water.merge(Vegetation).merge(Baren).merge(Forest).merge(Urban).merge(Dry_soil)
...
Map.addLayer(LULC_train, {min: 0, max: 5, palette: ['blue', 'yellow', 'grey', 'green','red','orange']}, 'LULC_train Map');
